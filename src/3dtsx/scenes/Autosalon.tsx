...
export default function Model(props: JSX.IntrinsicElements['group']) {
  const { nodes, materials } = useGLTF('assets/3d/transformed_gltf/scenes/Autosalon/Autosalon-transformed.glb') as GLTFResult
  ...
  return (
    <group {...props} dispose={null}>
      <PerspectiveCamera
        ...
        near={0.01}
        fov={20.102}
        position={[0, 1.7, 10.018]}
        rotation={[degToRad(-5), degToRad(0), degToRad(0)]}
      />
...
useGLTF.preload('assets/3d/transformed_gltf/scenes/Autosalon/Autosalon-transformed.glb')
